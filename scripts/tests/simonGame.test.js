...
const { game, newGame, showScore, addTurn, lightsOn, showTurns, playerTurn} = require("../simonGame");
...
describe("newgame works correctly", () => {
  ...
  test("should be one move in the computer game's array", () => {
...
describe("gameplay works correctly", () => {
  ...
  test("clicking during computer sequence should not register a move", () => {
    showTurns();
    game.lastButton = "";
